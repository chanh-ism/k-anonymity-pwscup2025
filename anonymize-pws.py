...
from metrics import CAVG, DM, NCP
from utils.types import AnonMethod
# -

from algorithms import k_anonymize, read_tree
from datasets import get_dataset_params
from utils.data import numberize_categories, read_raw, write_anon

parser = argparse.ArgumentParser("K-Anonymize")
parser.add_argument("--method", type=str, default="classic_mondrian", help="K-Anonymity Method")
parser.add_argument("--k", type=int, default=5, help="K-Anonymity or L-Diversity")
parser.add_argument("--dataset", type=str, default="b22_1", help="Dataset to anonymize")
